...
"}")
        ...
        MainWindow.setTabOrder(self.btn_import, self.spin_freq)
        ...
        MainWindow.setTabOrder(self.comb_bx_examp, self.horizontalSlider)
        MainWindow.setTabOrder(self.horizontalSlider, self.spin__samp_freq)
        MainWindow.setTabOrder(self.spin__samp_freq, self.list_comps)
        MainWindow.setTabOrder(self.list_comps, self.btn_mixed_plot)
        MainWindow.setTabOrder(self.btn_mixed_plot, self.btn_remove)
        MainWindow.setTabOrder(self.btn_remove, self.dial_noise)
        MainWindow.setTabOrder(self.dial_noise, self.graph_orignal)
