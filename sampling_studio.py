...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "choose example"))
        self.comboBox.setItemText(1, _translate("MainWindow", "example 1"))
        self.comboBox.setItemText(2, _translate("MainWindow", "example 2"))
        self.comboBox.setItemText(3, _translate("MainWindow", "example 3"))
        self.label_9.setText(_translate("MainWindow", "Ready templates"))
        self.checkBox.setText(_translate("MainWindow", "show examples"))
