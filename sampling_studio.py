...
"}")
        ...
        self.horizontalLayout_3.addWidget(self.lbl_fmax)
        ...
        font.setPointSize(12)
        font.setBold(True)
        self.lbl_samp_freq_abs.setFont(font)
        self.lbl_samp_freq_abs.setText("")
        self.lbl_samp_freq_abs.setObjectName("lbl_samp_freq_abs")
        self.horizontalLayout_4.addWidget(self.lbl_samp_freq_abs)
        ...
        MainWindow.setTabOrder(self.horizontalSlider, self.lineEdit)
        MainWindow.setTabOrder(self.lineEdit, self.graph_orignal)
